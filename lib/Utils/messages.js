...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
       ...
       m.eventMessage.contextInfo = {
        ...
        // 🔹 Buat interactiveMessage langsung dari productCategory
        const interactiveMessage = {
            ...
            nativeFlowMessage: WAProto_1.proto.Message.InteractiveMessage.NativeFlowMessage.create({
                // langsung ambil JSON dari message.productCategory
                messageParamsJson: message.productCategory
            })
        }
