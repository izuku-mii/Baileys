...
const makeMessagesRecvSocket = (config) => {
    ...
    const sendRetryRequest = async (node, forceIncludeKeys = false) => {
        const { fullMessage } = (0, Utils_1.decodeMessageNode)(node, authState.creds.me.id, '');
    ...
    const handleGroupNotification = (participant, child, msg) => {
        ...
        switch (child === null || child === void 0 ? void 0 : child.tag) {
            ...
            case 'subject':
                ...
                break;
            case 'description':
                const descriptionNode = (0, WABinary_1.getBinaryNodeChild)(child, 'body');
                const description = descriptionNode === null || descriptionNode === void 0 ? void 0 : descriptionNode.content;
                msg.messageStubType = Types_1.WAMessageStubType.GROUP_CHANGE_DESCRIPTION;
                msg.messageStubParameters = description ? [description.toString()] : undefined;
                break;
            case 'announcement':
    ...
    const handleMessage = async (node) => {
        ...
        if ((0, WABinary_1.getBinaryNodeChild)(node, 'unavailable') && !encNode) {
            await sendMessageAck(node);
            const { key } = (0, Utils_1.decodeMessageNode)(node, authState.creds.me.id, '').fullMessage;
        ...
        if (response && ((_b = (_a = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.includes(Utils_1.NO_MESSAGE_FOUND_ERROR_TEXT))) {
            ...
            await Promise.all([
                processingMutex.mutex(async () => {
                    ...
                    if (msg.messageStubType === WAProto_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
                        if (((_d = (_c = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.includes(Utils_1.MISSING_KEYS_ERROR_TEXT))) {
                            return sendMessageAck(node, Utils_1.NACK_REASONS.ParsingError);
                        }
                        const errorMessage = ((_f = (_e = msg === null || msg === void 0 ? void 0 : msg.messageStubParameters) === null || _e === void 0 ? void 0 : _e[0]) !== null && _f !== void 0 ? _f : '');
    ...
    const handleCall = async (node) => {
        ...
        let status = (0, Utils_1.getCallStatusFromNode)(infoChild);
        const call = {
            chatId: attrs.from,
            from,
            id: callId,
