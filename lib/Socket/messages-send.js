...
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (typeof content === 'object' &&
            ...
            else if ('productCategory' in content) {
                const { title, footer, thumbnail, interactiveButtons = [] } = content.productCategory;
                const header = thumbnail ? WAProto_1.proto.Message.productCategory.Header.create({
                    title: "",
                ...
                }) : WAProto_1.proto.Message.productCategory.Header.create({
                    title: "",
                ...
                const msg = await Utils_1.generateWAMessageFromContent(jid, {
                    viewOnceMessage: {
                        message: {
                            ...
                            productCategory: WAProto_1.proto.Message.productCategory.create({
                                body: { text: title },
                                footer: { text: footer },
                                header,
                                nativeFlowMessage: { interactiveButtons }
                            })
                        }
                    }
                }, { quoted });
